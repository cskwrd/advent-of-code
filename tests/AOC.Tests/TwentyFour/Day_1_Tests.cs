...
public class Day_1_Tests : TestBase
{
    ...
    const string EXAMPLE_1_INPUT = "AOC.Tests.Resources.Input.TwoThousand.TwentyFour.Day1.Example1.input.txt";
    const string EXAMPLE_2_INPUT = "AOC.Tests.Resources.Input.TwoThousand.TwentyFour.Day1.Example2.input.txt";
